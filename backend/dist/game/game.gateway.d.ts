...
export declare class GameGateway {
    ...
    private normalizeCoreHeistRole;
    private getCoreHeistRolePlan;
    private getCoreHeistRoleSkin;
    private applyCoreHeistRoleLoadout;
    ...
    isCoreHeistRoleRevealLocked(room: any, now?: number): boolean;
