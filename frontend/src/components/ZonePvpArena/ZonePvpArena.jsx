...
> <div className="fad-trail" /> <div className="fad-arm fad-arm-x" /> <div className="fad-arm fad-arm-y" /> <div className="fad-rotor fad-tl"><span /></div> <div className="fad-rotor fad-tr"><span /></div> <div className="fad-rotor fad-bl"><span /></div> <div className="fad-rotor fad-br"><span /></div> <div className="fad-shell" /> <div className="fad-light" /> </div>
);
}
...
{isMatchmaking && !connectionError && ( <div className="zone-pvp-matchmaking-screen"> <div className="zone-pvp-matchmaking-card"> <div className="zone-pvp-loader" /> <h1>{isCountdown ? "MATCH STARTS IN" : "WAITING FOR PLAYERS"}</h1> <strong>{isCountdown ? countdown : `${Math.min(playersAlive, minPlayers)} / ${minPlayers}`}</strong> <p>{isCountdown ? "Jucatorii au fost gasiti. Pregateste-te!" : "Se cauta inca un jucator pentru Zone PvP..."}</p> </div> </div>
)}
